      ...
      <main className="flex-1 container mx-auto px-4 py-8">
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <Link href="/book/main-deck" className="bg-white shadow-lg p-6 rounded-lg hover:shadow-2xl">
            <Image src="/floors/main-deck.jpg" alt="Main Deck" width={400} height={300} className="rounded-t-lg" />
          ...
          <Link href="/book/middle-deck" className="bg-white shadow-lg p-6 rounded-lg hover:shadow-2xl">
            <Image src="/floors/middle-deck.jpg" alt="Middle Deck" width={400} height={300} className="rounded-t-lg" />
          ...
          <Link href="/book/upper-deck" className="bg-white shadow-lg p-6 rounded-lg hover:shadow-2xl">
            <Image src="/floors/upper-deck.jpg" alt="Upper Deck" width={400} height={300} className="rounded-t-lg" />
